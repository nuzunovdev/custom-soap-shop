...
export function SoapConfiguratorSection({
  ...
  const canAddToCart =
    selectedSoapVariation !== undefined && selectedFragranceIds.length > 0;
  ...
  return (
    <section id="create" className="bg-[#FFFDF8] py-16">
          ...
          <div>
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              {soapFragrances.map((fragrance) => {
                ...
                const disabled = !checked && selectedFragranceIds.length >= 2;

                return (
                  <label
                    key={fragrance.id}
                    className={`flex items-center gap-2 rounded-xl border border-[#D6C3AA] bg-[#FFFDF8] px-3 py-2 text-sm ${
                      disabled
